...
export default function Navbar(){
    ...
    const collectData = async () =>{
        ...
        const result = await fetch(serverAddress + ':5000/api/adduser',{
            method:'post',
            body: JSON.stringify(userSentToAPI),
            headers:{
    ...
    const Login = async ()=>{
        ...
        const user = await fetch(serverAddress + ':5000/api/finduser',{
            method : 'post',
